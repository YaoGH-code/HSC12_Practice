...
msg2        DC.B   'When ready, input commonds gw, gt, gq or s + number.', $00
...
loopTxON
            ...
            ldaa    #prompt          ; cursor to next line
            jsr     putchar
            ldd   #1024
            std   DATAmax
            LBRA     init
...
backprint   jsr   pnum10             ;   to make the file RxData3.txt with exactly 1024 data 
oc2done     RTI
;***********end of Timer OC6 interrupt service routine********

sawtooth    ldd   ctr125u
...
triadd      ldab  tricounter
            incb
            stab  tricounter 
            bra    nexttri
            
trisub      ldab  tricounter
            decb
            stab  tricounter 
            bra    nexttri
...
triadd2     ldab  tricounter
            incb
            incb
            stab  tricounter 
            lbra    nexttri2
            
trisub2     ldab  tricounter
            decb
            decb
            stab  tricounter 
            lbra    nexttri2
